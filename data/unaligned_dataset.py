...
class UnalignedDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        # A_gray = 255.0-A_gray
        # im_array = np.array(A_img)
        # im_array=im_array/255
        # A_img = Image.fromarray(im_array)
        # im_array = np.array(B_img)
        # im_array=im_array/255
        # A_img = A_img.point(lambda x:x/255.0)
        # B_img = B_img.point(lambda x:x/255.0)
        # print( A_img )
        # print( B_img )
        # B_img = Image.fromarray(im_array)
        # A_img = A_img/255.0
        # B_img = B_img/255.0
        ...
        return {'A': A_img, 'B': B_img,'V':ww, 'A_gray': A_gray, 'input_img': input_img,
